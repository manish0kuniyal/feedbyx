...
export default function Dashboard() {
  ...
  const topButtons = [
    { label: "Create", value: "create", icon: <FaPlus /> },
    { label: "Forms", value: "view", icon: <SiFormspree /> },
    { label: "Responses", value: "responses", icon: <MdOutlineHowToVote /> },
    {
      label: "Analytics",
      value: "admin",
                ...
                {topButtons.map((btn, idx) => {
                  ...
                  return (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      className={`flex items-center justify-between gap-3 mb-3 px-4 py-3 w-11/12 mx-auto rounded-2xl font-semibold text-base transition-all duration-300
                        ${
                          btn.gradient
                            ? "text-white bg-gradient-to-r from-[var(--blue)] via-[var(--lightblue)] to-[var(--white)] shadow-lg"
                            : ""
                        }
                        ${
                          isActive
                            ? "ring-2 ring-[var(--lightblue)] bg-white/10"
                            : darkMode
